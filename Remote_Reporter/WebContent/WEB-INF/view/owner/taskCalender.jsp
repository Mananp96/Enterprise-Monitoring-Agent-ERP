        ...
        <div class="rightside bg-white">
            ...
            <div class="page-head bg-grey-50" style="height:100px">
				...
				<div class="container col-lg-4">
					...
					<a href="dealCalender.do" ><button  type="submit" class="btn btn-dark bg-light-blue-300 color-white" style="width:40%" data-toggle="modal" data-target="#calendar2">Deal Calendar</button></br><i class="fa fa-caret-down" style="margin-left: 72px;margin-top: -4px;"></i></a>
								  ...
								  <div class="modal-dialog">
									<div class="modal-content">
									  <div class="modal-header no-border">
										...
										<h4 class="modal-title" id="myModalLabel"><i class="ion-calendar"></i> Create Task Event</h4>
									  </div>
