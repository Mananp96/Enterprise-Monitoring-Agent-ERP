...
<body>
	...
	<div class="wrapper">
        ...
        <div class="rightside bg-grey-100">
			<!-- BEGIN PAGE HEADING -->
            <div class="page-head">
				<h1 class="page-title">Deal Documents<small>small text goes here</small></h1>
				<!-- BEGIN BREADCRUMB -->
                        ...
                        <div class="col-lg-12">
							<div class="panel no-border ">
                                ...
                                <div class="panel-body">
                                	<c:forEach items="${sessionScope.dealfolderlist}" var="i">
                                			<tr>
                                				<td><img src="assets/img/folder.ico"/>${i}</td>
