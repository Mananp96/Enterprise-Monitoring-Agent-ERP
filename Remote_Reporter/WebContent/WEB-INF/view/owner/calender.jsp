...
<body class="fixed-header fixed-leftside">
	...
	<div class="wrapper">
		<!-- BEGIN LEFTSIDE -->
         <jsp:include page="menu.jsp"></jsp:include>		<!-- END LEFTSIDE -->

		<!-- BEGIN RIGHTSIDE -->
        <div class="rightside bg-white">
			<!-- BEGIN PAGE HEADING -->
            <div class="page-head bg-grey-50">
				<h1 class="page-title">Calendar<small>Show your Deal</small></h1>
			</div>
			<!-- END PAGE HEADING -->
				...
				<div class="row">
							...
							<!-- <div class="panel no-shadow no-radius bg-light-blue-500">
								...
								<inputtype="hidden" value="${j.dealDesc }" name="dealdesc"/>					
									...
									<div class="modal fade" id="dealModalForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
								  <div class="modal-dialog">
                                    ...
                                    <dl>
                                    	...
                                    	<div class="col-md-4">
                                        <dt><h4>Milestone</h4></dt>
                                        <dd><h4>${j.milestone }</h4></dd>
                                        </div>
                                        
                                        <div class="col-md-4">
                                        <dt><h4>Deal Value</h4></dt>
                                        <dd><h4>${j.dealValue }</h4></dd>
                                        </div>
                                        
                                        <div class="col-md-4">
                                        <dt><h4>Related To</h4></dt>
                                        <dd><h4>${j.ownerContactVo.firstName } ${j.ownerContactVo.lastName }</h4></dd>
                                        </div>
                                    </dl>
                                </div>
	...
	<script type="text/javascript">
		$(function() {
				...
				for(var i=0; i<dealname.length;i++)
					...
					dt = dt +'{"title": "'+dealname[i].value+'","start": "'+dealdate[i].value+'","description": "'+closedate[i].value+'","dealDesc":"'+dealdate[i].value+'"}';
