...
<head>
	...
	<title>Maniac - Edit Country</title>
...
<body class="fixed-header">
	...
	<div class="wrapper">
        ...
        <div class="rightside bg-grey-100">
			<!-- BEGIN PAGE HEADING -->
            <div class="page-head">
				<h1 class="page-title">Edit Country<small>Enter the Country</small></h1>
				<!-- BEGIN BREADCRUMB -->
				<ol class="breadcrumb">
					...
					<div class="col-lg-12">
                      <div class="panel">
							...
							<div class="text-center padding-left-20 padding-right-20 margin-bottom-20 border-bottom-1 border-grey-100">
								<h3 class="color-grey-700 margin-top-30">Edit Country</h3>
								<p class="text-light margin-bottom-30">Individual form controls automatically receive some global styling.</p>
							</div>
							
							<f:form role="form" class="form-horizontal" id="registerForm" action="update.do" method="post" modelAttribute="update">
								...
								<div class="col-lg-8 col-lg-offset-2">
										<div class="panel-body padding-bottom-40 padding-left-20 padding-right-20">
											  ...
											  <f:input  type="hidden" path="id" />
												...
												<div class="col-lg-8">
													<f:input type="text" class="form-control" id="country_name" path="countryName"/>
												</div>
											  </div>
											  <div class="form-group">
												<label for="country_desc" class="control-label col-lg-2">Description</label>
												<div class="col-lg-8">
													<!--<f:input type="text" class="form-control" id="country_desc" name="country_desc" path="countryDesc"/>-->
													<f:textarea class="form-control" rows="5" id="country_desc" path="countryDesc"></f:textarea> 
												</div>
											  </div>
											  <div class="form-group">
													<label for="country_code" class="control-label col-lg-2">Country Code</label>
													<div class="col-lg-6">
														<f:input id="country_code" type="text" class="form-control" path="countryCode" />
													</div>	
										      </div>
