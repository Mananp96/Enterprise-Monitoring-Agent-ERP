...
<body>
	...
	<div class="wrapper animated fadeInDown">
		<div class="panel overflow-hidden"
			style="margin: 100px 434px 0px 437px;">
			<div
 ...
 %>
					...
					<div class="form-group" style="margin-bottom: 39px;">
						<p style="color: grey;font-size: 15px">Don't worry! Just fill in your
							email and we'll help<br>you reset your password.
						</p>
					</div>

					<div class="form-group">

						<span><label for="text" class="control-label">EMAIL
