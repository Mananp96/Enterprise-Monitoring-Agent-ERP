...
public class ownerFolder {
    ...
    public String openFolder(/*@RequestParam("values") List folderId,*/ HttpSession session, HttpServletRequest req,Model model){
        ...
        System.out.println("Hello From USerFileCOntroller");
        ...
        List ls=userFileDAO.fileSearch(fileVO);
        session.setAttribute("List11",ls);*/
        /*for folder*/
