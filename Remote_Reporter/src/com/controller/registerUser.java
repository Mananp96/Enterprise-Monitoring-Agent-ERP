...
public class registerUser {
	...
	public ModelAndView createUser(HttpServletRequest req,@RequestParam String firstname,@RequestParam String lastname,@RequestParam String companyname,@RequestParam("username") String username,@RequestParam String password)
	{
