...
public class ownerDocuments {
	...
	public String gettask(@ModelAttribute documentVo documentVo, HttpServletRequest req) {
		...
		/*
		 * List ls = documentDao.getfolder(documentVo); System.out.println("manan");
		 * 
 ...
 * 
 * import com.dao.documentDao; import com.vo.documentVo;
 * 
 * @Controller public class ownerDocuments {
 * 
 * @Autowired documentDao documentDao;
 * 
 * @RequestMapping(value="/ownerDocuments.do",method=RequestMethod.GET) public
 * ModelAndView gettask(@ModelAttribute documentVo documentVo,HttpServletRequest
 * req) { List ls = documentDao.getfolder(documentVo);
 * System.out.println("manan"); HttpSession session = req.getSession();
 * session.setAttribute("FolderList", ls); return new
 * ModelAndView("owner/ownerDocuments"); } }
 */